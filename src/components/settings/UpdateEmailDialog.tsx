    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter your new email address. We will send a confirmation link to both your old and new inbox to verify this change.
          </DialogDescription>
        </DialogHeader>
        ...
        {success ? (
          <div className="flex flex-col items-center gap-4 py-8 text-center text-green-700">
            ...
            <p className="text-sm text-green-600/80">Please check both your old and new email inboxes to confirm the change securely.</p>
          ...
          <form onSubmit={handleUpdateEmail} className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <Input id="currentEmail" value={currentEmail} disabled className="bg-gray-50 text-gray-500" />
            </div>
            ...
            <DialogFooter className="mt-4">
              ...
              <Button type="submit" disabled={loading || !newEmail || newEmail === currentEmail} className="bg-[#2E75B6] hover:bg-[#1F4E79] text-white">
