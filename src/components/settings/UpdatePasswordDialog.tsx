      ...
      <DialogContent className="sm:max-w-md">
        ...
        {success ? (
          <div className="flex flex-col items-center gap-4 py-8 text-center text-green-700">
            ...
            <p className="text-sm text-green-600/80">Your new password has been safely encrypted and saved.</p>
            <Button onClick={() => setOpen(false)} className="mt-4 bg-[#2E75B6] hover:bg-[#1F4E79] text-white">Done</Button>
          </div>
        ) : (
          <form onSubmit={handleUpdatePassword} className="flex flex-col gap-4">
            ...
            <DialogFooter className="mt-4">
              ...
              <Button type="submit" disabled={loading || !oldPassword || !newPassword || !confirmPassword} className="bg-[#2E75B6] hover:bg-[#1F4E79] text-white">
