  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        {hasUnsavedChanges && <p className="text-xs text-amber-600">* Unsaved changes</p>}
      </div>

      {/* Identity and Contact Section */}
      <div className="flex flex-col gap-4">
        <h2 className="border-b pb-2 text-xl font-semibold text-gray-900">Identity & Contact</h2>
